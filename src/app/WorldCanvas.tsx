import { Suspense, memo, useEffect, useRef, useMemo, type RefObject } from 'react';
...
function SceneCanvas({active,settings,controller,onReady,onError,locale='en',playerRef,collectedIds,onCollect}:{locale?:Locale;active:boolean;settings:GameSettings;controller:ExplorerControllerProps;onReady:()=>void;onError:(error:string)=>void;playerRef:RefObject<PlayerSnapshot>;collectedIds:readonly string[];onCollect:(item:CollectItem)=>void}){

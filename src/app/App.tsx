...
import { CAR_PICKER_CATALOG, type CarModelId } from '../content/assets/models';
...
export function App(){
  ...
  const controller=useMemo<ExplorerControllerProps>(()=>({mode,profile,spawn,initialHeading,resetToken,inputCommands:receiveCommands,bicycleSpawn,returnBicycleToken,carSpawnToken,carModelId,sensitivity:settings.sensitivity,reducedMotion:settings.reducedMotion,cameraControl:settings.cameraControl,onSnapshot,onPause,onMap,onReady:onPlayerReady,onError:onSceneError}),[mode,profile,spawn,initialHeading,resetToken,receiveCommands,bicycleSpawn,returnBicycleToken,carSpawnToken,carModelId,settings.sensitivity,settings.reducedMotion,settings.cameraControl,onSnapshot,onPause,onMap,onPlayerReady,onSceneError]);

...
interface Props { url: string; height?: number; length?: number; rotationY?: number; name?: string; motion?: RefObject<AvatarMotion>; animation?: 'nick' | 'kid-boy' | 'little-girl' | 'uniform'; carModel?: CarModelId; carMotion?: RefObject<CarMotion> }

...
import { malakkapparaTownBoxes } from '../../../src/content/world/malakkapparaTown';
...
import { mountainDressingBoxes } from '../../../src/content/world/mountainDressing';
...
export function createCanonicalWorldDefinition(): SimulationWorldDefinition {
  return {
    ...
    boxes: [...staticArchitectureBoxes(), ...canopyArchitectureBoxes(), ...mountainArchitectureBoxes(), waterfallBarrierBox(), ...staticForestBoxes(), ...CHALAKKUDY_STREET.boxes, ...v2DressingBoxes(), ...chalakkudyCityBoxes(), ...malakkapparaTownBoxes(), ...airportBoxes(), ...snehaTheeramBoxes(), ...mountainDressingBoxes()],

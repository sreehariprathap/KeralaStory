...
export function createCanonicalWorldDefinition(): SimulationWorldDefinition {
  return {
    ...
    boxes: [...staticArchitectureBoxes(), ...canopyArchitectureBoxes(), ...mountainArchitectureBoxes(), waterfallBarrierBox(), ...staticForestBoxes(), ...CHALAKKUDY_STREET.boxes, ...v2DressingBoxes(), ...chalakkudyCityBoxes(), ...airportBoxes(), ...snehaTheeramBoxes(), ...mountainDressingBoxes()],

...
- Mobile:
  ...
  - Short landscape screens: the title layout no longer overlaps the region strip, and Sprint lock sits beside the joystick instead of over the coin counter. Both overlaps also existed on the main branch.
- Checks run:
